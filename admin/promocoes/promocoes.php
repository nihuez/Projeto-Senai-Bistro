                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-borderless mb-3">
                                        <div class="texto" style="font-family: 'Dancing Script', cursive; font-size:100px"><h1>Gerenciamento de Promoções</h1></div>
                                        <thead>
                                        ...
                                        <tbody class="text">
                                            <?php foreach ($desconto as $desconto): ?>
                                                <tr>
                                                    <td><?php echo $desconto['item']; ?></td>
                                                    <td><?php echo $desconto['valor']; ?></td>
                                                    
                                                    <td><button type="button" class="btn btn-warning btn-sm px-3" style="margin:2px">
                                                    <a style="color:black;" href="edit.php?id=<?php echo $desconto['id']?>"><i class="fa fa-edit"></i></td>
                                                        <td><button type="button" class="btn btn-dark btn-sm px-3">
                                                        <a  style="color:white;" href=<?php echo "promo-control.php?del_id=". $desconto['id'];?>><i class="fa fa-trash"></i></td>
                                                        </button>
                                                        </button>
